...
import io.gravitee.am.gateway.handler.common.group.GroupManagerFacade;
...
import io.gravitee.am.gateway.handler.common.role.RoleManagerFacade;
...
public class CommonConfiguration {
    ...
    @Bean
    public GroupManagerFacade groupManager(@Value("${sync.groups.enabled:false}") Boolean enabled) {
        if (enabled) {
    ...
    @Bean
    public RoleManagerFacade roleManager(@Value("${sync.roles.enabled:false}") Boolean enabled) {
        if (enabled) {
    ...
    @Bean
    @Primary
    public UserEnhancer facadeManagerUserEnhancer(GroupManagerFacade groupManagerFacade, RoleManagerFacade roleManagerFacade) {
        return new UserEnhancerFacade(groupManagerFacade, roleManagerFacade);
    }
