...
public class InMemoryGroupManager extends AbstractService implements GroupManagerFacade, InitializingBean, GroupManager, EventListener<GroupEvent, Payload> {
